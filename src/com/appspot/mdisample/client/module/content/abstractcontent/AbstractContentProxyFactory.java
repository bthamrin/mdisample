...
public class AbstractContentProxyFactory<P extends AbstractContentPresenter, V extends AbstractContentView> {
	...
	@Inject
	public AbstractContentProxyFactory(Provider<AbstractContentPresenterProvider<P, V>> provider, ProxyFailureHandler failureHandler,
			PlaceManager placeManager, EventBus eventBus, Class<P> presenterClass) {
	...
	public AbstractContentProxy<P> create(String name) {
